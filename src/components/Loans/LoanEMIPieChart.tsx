...
export default function LoanEMIPieChart({
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <svg width={svgSize} height={svgSize} viewBox="0 0 120 120" className="overflow-visible">
        ...
        <text
          ...
          y={isSmall ? 53 : 55}
          textAnchor="middle"
          className={`font-display font-700 ${isSmall ? 'text-[11px]' : 'text-[14px]'}`}
          fill="var(--foreground)"
        >
