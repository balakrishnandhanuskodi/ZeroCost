...
export default function DashboardEMISplit({
  ...
  return (
    <div className="bg-[var(--card)] border border-[var(--border)] rounded-lg p-4">
      ...
      {/* Total EMI */}
      <div className="bg-[var(--primary-soft)] border border-[var(--primary)] rounded-lg p-3 mb-3">
      ...
      <div className="grid grid-cols-2 gap-2.5">
        {/* Principal */}
        <div className="bg-[var(--muted)] rounded-lg p-2.5 space-y-1.5">
          <div className="flex items-center justify-between">
            <p className="text-[9px] text-[var(--muted-foreground)] font-semibold uppercase">
              Going to Principal
            </p>
      ...
      {/* Insight */}
      <div className="mt-3 p-2.5 bg-[var(--primary-soft)] border border-[var(--primary)] rounded-lg">
